...
! In this module,
!     read out and set the namelist variables for rstruct.
...
! If error occured, call the procedure destroy.
      ...
      if(stat.lt.0) then
        ...
        call destroy('setnlrst',8,'stop',1001,'              ',14,5,    &
     &               stat)
...
! -----
      ...
      end subroutine s_setnlrst

!-----7--------------------------------------------------------------7--

      end module m_setnlrst
