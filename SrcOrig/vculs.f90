...
!***********************************************************************
      subroutine s_vculs(fpdziv,ivstp,dtsep,ni,nj,nk,wc8s,sp,sf)
!***********************************************************************
...
!$omp do schedule(runtime) private(i,j,a,b,c)
     ...
     &        +2.e0*sp(i,j,k+1)+sp(i,j,k-2)-6.e0*sp(i,j,k-1))
            ...
            sf(i,j,k)=sp(i,j,k)                                         &
     &        +((a*wc8s(i,j,k)+b)*wc8s(i,j,k)+c)*wc8s(i,j,k)
...
!$omp do schedule(runtime) private(i,j,a,b,c)
      ...
      do i=2,ni-2
        ...
        if(wc8s(i,j,2).gt.0.e0) then
          ...
          sf(i,j,2)=sp(i,j,2)+dzt1*wc8s(i,j,2)*(sp(i,j,2)-sp(i,j,1))
     ...
     &      -sp(i,j,4)-2.e0*sp(i,j,1)-3.e0*sp(i,j,2))
          ...
          sf(i,j,2)=sp(i,j,2)                                           &
     &      +((a*wc8s(i,j,2)+b)*wc8s(i,j,2)+c)*wc8s(i,j,2)
     ...
     &      +2.e0*sp(i,j,nkm1)+sp(i,j,nkm4)-6.e0*sp(i,j,nkm3))
          ...
          sf(i,j,nkm2)=sp(i,j,nkm2)                                     &
     &      +((a*wc8s(i,j,nkm2)+b)*wc8s(i,j,nkm2)+c)*wc8s(i,j,nkm2)

        else

          sf(i,j,nkm2)=sp(i,j,nkm2)                                     &
     &      +dzt1*wc8s(i,j,nkm2)*(sp(i,j,nkm1)-sp(i,j,nkm2))
