...
! Open the united file.
  ...
  100 if(stat.ne.0) then
     ...
     &               stat)
      ...
      call outstd03('unidmpgr',8,unifl,ncuni,iouni,1,1,ctime)
...
! Open the dumped file.
  ...
  110       if(stat.ne.0) then
     ...
     &                     iodmp(0),stat)
            ...
            call outstd03('unidmpgr',8,dmpfl,ncdmp,iodmp(0),1,1,ctime)
...
! united file.
  ...
  120       if(recdmp.eq.1) then
     ...
     &                     iodmp(0),stat)
            ...
            call outstd03('unidmpgr',8,unifl,108,iouni,4,1,ctime)
...
! Close the dumped file.
  ...
  130       if(stat.ne.0) then
     ...
     &                     iodmp(0),stat)
            ...
            call outstd03('unidmpgr',8,unifl,108,iodmp(0),2,1,ctime)
...
! Open the dumped file.
     ...
     &                  'dmp',ctime/1000_i8,'.grp',mygrp,'-sub'
  ...
  140         if(stat.ne.0) then
     ...
     &                       iodmp(isub),stat)
              ...
              call outstd03('unidmpgr',8,dmpfl,ncdmp,iodmp(isub),1,1,   &
     &                      ctime)
  ...
  150       if(recdmp.eq.1) then
     ...
     &                     iodmp(isub),stat)
              ...
              do isub=0,nisub-1
                ...
                call outstd03('unidmpgr',8,dmpfl,108,iodmp(isub),3,1,   &
     &                        ctime)
...
! Close the dumped file.
  ...
  160         if(stat.ne.0) then
     ...
     &                       iodmp(isub),stat)
              ...
              call outstd03('unidmpgr',8,dmpfl,108,iodmp(isub),2,1,     &
     &                      ctime)
...
! Open the dumped file.
  ...
  170     if(stat.ne.0) then
     ...
     &                   iodmp(mysub),stat)
          ...
          call outstd03('unidmpgr',8,dmpfl,ncdmp,iodmp(mysub),1,1,ctime)
  ...
  180   if(recdmp.eq.1) then
     ...
     &                 iodmp(mysub),stat)
          ...
          do mysub=0,nsub-1
            ...
            call outstd03('unidmpgr',8,dmpfl,108,iodmp(mysub),3,1,ctime)
...
! Close the dumped file.
  ...
  190     if(stat.ne.0) then
     ...
     &                   iodmp(mysub),stat)
          ...
          call outstd03('unidmpgr',8,dmpfl,108,iodmp(mysub),2,1,ctime)
...
! Close the united file.
  ...
  200 if(stat.ne.0) then
     ...
     &               stat)
      ...
      call outstd03('unidmpgr',8,unifl,108,iouni,2,1,ctime)
...
! If error occured, call the procedure destroy.
  ...
  210 call destroy('unidmpgr',8,'cont',4,'              ',14,iouni,     &
     &             stat)
  ...
  230 if(stat.ne.0) then
     ...
     &               stat)
      ...
      call destroy('unidmpgr',8,'stop',1001,'              ',14,101,    &
     &             stat)

! -----

      end subroutine s_unidmpgr

!-----7--------------------------------------------------------------7--

      end module m_unidmpgr
