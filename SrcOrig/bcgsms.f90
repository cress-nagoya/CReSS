...
! In this module,
!     set the boundary conditions for optional scalar variable in GPV
!     data smoothing.
...
!***********************************************************************
      subroutine s_bcgsms(fpwbc,fpebc,fpsbc,fpnbc,ni,nj,nk,dfs)
!***********************************************************************
...
! Input and output variable
      ...
      real, intent(inout) :: dfs(0:ni+1,0:nj+1,1:nk)
                       ! Diffusion term of optional scalar of GPV
