...
! In this module,
!     perform the 4th order smoothing for the water vapor mixing ratio.
...
!***********************************************************************
      subroutine s_smoo4qv(fpsmtopt,fpiwest,fpieast,fpjsouth,fpjnorth,  &
     &                     fpsmhcoe,fpsmvcoe,ni,nj,nk,qvbr,rbr,qv,      &
     &                     qvfrc,rbrqv,rbrqv2,tmp1,tmp2,tmp3)
!***********************************************************************
...
! Internal shared variables
      ...
      real, intent(inout) :: rbrqv2(0:ni+1,0:nj+1,1:nk)
                       ! 2.0 x rbrqv
