...
!                   1999/08/09, 1999/08/18, 1999/08/23, 1999/09/06,
!                   1999/09/30, 1999/10/07, 1999/10/12, 1999/11/01,
!                   1999/11/19, 1999/12/06, 1999/12/17, 2000/01/17,
!                   2000/02/02, 2000/03/17, 2000/04/18, 2000/12/18,
!                   2001/01/15, 2001/03/13, 2001/05/29, 2001/06/06,
!                   2001/06/29, 2001/07/13, 2001/08/07, 2001/11/20,
...
!***********************************************************************
      subroutine s_steppe(fpexbvar,fpexbopt,isstp,dts,gtinc,ni,nj,nk,   &
     &                    jcb,pfrc,psml,pcpx,pcpy,ppgpv,pptd,ppf)
!***********************************************************************
...
! Input variables
      ...
      real, intent(in) :: psml(0:ni+1,0:nj+1,1:nk)
...
!$omp do schedule(runtime) private(i,j)
        ...
        do j=2,nj-2
        do i=2,ni-2
          ppf(i,j,k)=ppf(i,j,k)+dts*(pfrc(i,j,k)+psml(i,j,k))/jcb(i,j,k)
        end do
        end do
