...
! In this module,
!     generate the united geography file from the dumped files in group
!     domain.
...
! Open the united file.
  ...
  100 if(stat.ne.0) then
        ...
        call destroy('unigeogr',8,'stop',1,'              ',14,iouni,   &
     &               stat)

      end if

      call outstd03('unigeogr',8,unifl,ncuni,iouni,1,0,0_i8)
...
! Open the dumped file.
  ...
  110       if(stat.ne.0) then
              ...
              call destroy('unigeogr',8,'cont',1,'              ',14,   &
     &                     iodmp(0),stat)
            ...
            call outstd03('unigeogr',8,dmpfl,ncdmp,iodmp(0),1,0,0_i8)
...
! united file.
  ...
  120       if(recdmp.eq.1) then
              ...
              call destroy('unigeogr',8,'cont',3,'              ',14,   &
     &                     iodmp(0),stat)
              ...
              call outstd03('unigeogr',8,dmpfl,108,iodmp(0),3,0,0_i8)

            end if

            call outstd03('unigeogr',8,unifl,108,iouni,4,0,0_i8)
...
! Close the dumped file.
  ...
  130       if(stat.ne.0) then
              ...
              call destroy('unigeogr',8,'cont',2,'              ',14,   &
     &                     iodmp(0),stat)
            ...
            call outstd03('unigeogr',8,unifl,108,iodmp(0),2,0,0_i8)
...
! Open the dumped file.
  ...
  140         if(stat.ne.0) then
     ...
     &                       iodmp(isub),stat)
              ...
              call outstd03('unigeogr',8,dmpfl,ncdmp,iodmp(isub),1,0,   &
     &                      0_i8)
  ...
  150       if(recdmp.eq.1) then
     ...
     &                     iodmp(isub),stat)
              ...
              do isub=0,nisub-1
                ...
                call outstd03('unigeogr',8,dmpfl,108,iodmp(isub),3,0,   &
     &                        0_i8)
...
! Close the dumped file.
  ...
  160         if(stat.ne.0) then
     ...
     &                       iodmp(isub),stat)
              ...
              call outstd03('unigeogr',8,dmpfl,108,iodmp(isub),2,0,0_i8)
...
! Open the dumped file.
  ...
  170     if(stat.ne.0) then
     ...
     &                   iodmp(mysub),stat)
          ...
          call outstd03('unigeogr',8,dmpfl,ncdmp,iodmp(mysub),1,0,0_i8)
  ...
  180   if(recdmp.eq.1) then
     ...
     &                 iodmp(mysub),stat)
          ...
          do mysub=0,nsub-1
            ...
            call outstd03('unigeogr',8,dmpfl,108,iodmp(mysub),3,0,0_i8)
...
! Close the dumped file.
  ...
  190     if(stat.ne.0) then
     ...
     &                   iodmp(mysub),stat)
          ...
          call outstd03('unigeogr',8,dmpfl,108,iodmp(mysub),2,0,0_i8)
...
! Close the united file.
  ...
  200 if(stat.ne.0) then
        ...
        call destroy('unigeogr',8,'stop',2,'              ',14,iouni,   &
     &               stat)

      end if

      call outstd03('unigeogr',8,unifl,108,iouni,2,0,0_i8)
...
! If error occured, call the procedure destroy.
  ...
  210 call destroy('unigeogr',8,'cont',4,'              ',14,iouni,     &
     &             stat)
  ...
  230 if(stat.ne.0) then
     ...
     &               stat)
      ...
      call destroy('unigeogr',8,'stop',1001,'              ',14,101,    &
     &             stat)

! -----

      end subroutine s_unigeogr

!-----7--------------------------------------------------------------7--

      end module m_unigeogr
