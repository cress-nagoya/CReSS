...
!     Date        : 2008/04/17
!     Modification: 2008/05/02, 2008/08/25, 2008/10/10, 2008/12/11,
!                   2009/02/27

!-----7--1----+----2----+----3----+----4----+----5----+----6----+----7--

! In this module,
!     read out and set the namelist variables for gridata.
...
! If error occured, call the procedure destroy.
      ...
      if(stat.lt.0) then
        ...
        call destroy('setnlgpv',8,'stop',1001,'              ',14,5,    &
     &               stat)
...
! -----
      ...
      end subroutine s_setnlgpv

!-----7--------------------------------------------------------------7--

      end module m_setnlgpv
