...
!***********************************************************************
      subroutine s_rdres(fpexprim,fpcrsdir,fpdmpvar,fpncexp,fpnccrs,    &
     &                  fpwbc,fpebc,fpsbc,fpnbc,fpsfcopt,fpadvopt,      &
     &                  fpcphopt,fpqcgopt,fpaslopt,fptrkopt,fptubopt,   &
     &                  fpdiaopt,fpstime,fproc,fmois,ni,nj,nk,          &
  ...
  100   call chkerr(stat)
        ...
        if(stat.lt.0) then
          ...
          if(mype.eq.-stat-1) then
            ...
            call destroy('rdres   ',5,'cont',1,'              ',14,     &
     &                   iores,stat)
          ...
          call destroy('rdres   ',5,'stop',1001,'              ',14,101,&
     &                 stat)
        ...
        if(mype.eq.root) then
          ...
          call outstd03('rdres   ',5,resfl,ncexp+21,iores,1,0,0_i8)
  ...
  110   call chkerr(stat)
        ...
        if(stat.lt.0) then
          ...
          if(mype.eq.-stat-1) then
            ...
            call destroy('rdres   ',5,'cont',3,'              ',14,     &
     &                   iores,stat)
     ...
     &                 stat)
        ...
        if(mype.eq.root) then
          ...
          call outstd03('rdres   ',5,resfl,108,iores,3,0,0_i8)
...
! Check the restart checking file.
        ...
        if(mype.eq.root) then
          ...
          call chkfile('res',stat,ncn,nin,nrn,                          &
  ...
  120   call chkerr(stat)
        ...
        if(stat.lt.0) then
          ...
          if(mype.eq.-stat-1) then
            ...
            call destroy('rdres   ',5,'cont',2,'              ',14,     &
     &                   iores,stat)
     ...
     &                 stat)
        ...
        if(mype.eq.root) then
          ...
          call outstd03('rdres   ',5,resfl,108,iores,2,0,0_i8)
...
! Open the restart file.
     ...
     &          'res',int(stime+.1e0),'.pe',mysub,'.bin'
     ...
     &          'res',int(stime+.1e0),'.grp',mygrp,'-sub',mysub,'.bin'
  ...
  130 call chkerr(stat)
      ...
      if(stat.lt.0) then
        ...
        if(mype.eq.-stat-1) then
          ...
          call destroy('rdres   ',5,'cont',1,'              ',14,iores, &
     &                 stat)
     ...
     &               stat)
      ...
      if(mype.eq.stat-1) then
        ...
        call outstd03('rdres   ',5,resfl,ncfl,iores,1,0,0_i8)
  ...
  140 call chkerr(stat)
      ...
      if(stat.lt.0) then
        ...
        if(mype.eq.-stat-1) then
          ...
          call destroy('rdres   ',5,'cont',3,'              ',14,iores, &
     &                 stat)
  ...
  150 call chkerr(stat)
      ...
      if(stat.lt.0) then
        ...
        if(mype.eq.-stat-1) then
          ...
          call destroy('rdres   ',5,'cont',2,'              ',14,iores, &
     &                 stat)
