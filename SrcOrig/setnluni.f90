...
! In this module,
!     read out and set the namelist variables for unite.
...
! If error occured, call the procedure destroy.
      ...
      if(stat.lt.0) then
        ...
        call destroy('setnluni',8,'stop',1001,'              ',14,5,    &
     &               stat)
...
! -----
      ...
      end subroutine s_setnluni

!-----7--------------------------------------------------------------7--

      end module m_setnluni
