...
!                   2003/12/12, 2004/05/31, 2004/09/10, 2006/02/13,
...
!***********************************************************************
      subroutine s_rbcs(fplbcvar,fpwbc,fpebc,fpsbc,fpnbc,fpadvopt,      &
...
!$omp do schedule(runtime) private(k,radwe,radsn)
           ...
           do k=2,nk-2
             ...
             sf(1,1,k)=sp(1,1,k)-2.e0*(radwe+radsn)-dmpdt*sp(1,1,k)
...
!$omp do schedule(runtime) private(k,radwe,radsn)
     ...
     &         *scpy(nim1,k,1)/(1.e0-scpy(nim1,k,1))
             ...
             sf(nim1,1,k)=sp(nim1,1,k)+2.e0*(radwe-radsn)               &
     &         -dmpdt*sp(nim1,1,k)
...
!$omp do schedule(runtime) private(k,radwe,radsn)
     ...
     &         *scpy(1,k,2)/(1.e0+scpy(1,k,2))
             ...
             sf(1,njm1,k)=sp(1,njm1,k)-2.e0*(radwe-radsn)               &
     &         -dmpdt*sp(1,njm1,k)
...
!$omp do schedule(runtime) private(k,radwe,radsn)
     ...
     &         *scpy(nim1,k,2)/(1.e0+scpy(nim1,k,2))
             ...
             sf(nim1,njm1,k)=sp(nim1,njm1,k)+2.e0*(radwe+radsn)         &
     &         -dmpdt*sp(nim1,njm1,k)
...
!$omp do schedule(runtime) private(k,radwe,radsn)
           ...
           do k=2,nk-2
             ...
             sf(nim1,njm1,k)=sp(nim1,njm1,k)+(radwe+radsn)              &
     &         -dmpdt*sp(nim1,njm1,k)
...
!$omp do schedule(runtime) private(j,k,gamma)
            ...
            do j=2,nj-2
              ...
              sf(1,j,k)=sp(1,j,k)-gamma*(s(2,j,k)-sp(1,j,k))            &
     &          -dmpdt*sp(1,j,k)
...
!$omp do schedule(runtime) private(j,k)
            ...
            do k=2,nk-2
            do j=2,nj-2
              sf(1,j,k)=sp(1,j,k)-scpx(j,k,1)*(sp(2,j,k)-sp(1,j,k))     &
     &          -dmpdt*sp(1,j,k)
            end do
            end do
...
!$omp do schedule(runtime) private(j,k,gamma)
            ...
            do j=2,nj-2
              ...
              sf(nim1,j,k)=sp(nim1,j,k)+gamma*(s(nim2,j,k)-sp(nim1,j,k))&
     &          -dmpdt*sp(nim1,j,k)
...
!$omp do schedule(runtime) private(j,k)
            ...
            do k=2,nk-2
            do j=2,nj-2
              sf(nim1,j,k)=sp(nim1,j,k)+scpx(j,k,2)                     &
     &          *(sp(nim2,j,k)-sp(nim1,j,k))-dmpdt*sp(nim1,j,k)
            end do
            end do
...
!$omp do schedule(runtime) private(i,k,gamma)
            ...
            do i=2,ni-2
              ...
              sf(i,1,k)=sp(i,1,k)-gamma*(s(i,2,k)-sp(i,1,k))            &
     &          -dmpdt*sp(i,1,k)
...
!$omp do schedule(runtime) private(i,k)
            ...
            do k=2,nk-2
            do i=2,ni-2
              sf(i,1,k)=sp(i,1,k)-scpy(i,k,1)*(sp(i,2,k)-sp(i,1,k))     &
     &          -dmpdt*sp(i,1,k)
            end do
            end do
...
!$omp do schedule(runtime) private(i,k,gamma)
            ...
            do i=2,ni-2
              ...
              sf(i,njm1,k)=sp(i,njm1,k)+gamma*(s(i,njm2,k)-sp(i,njm1,k))&
     &          -dmpdt*sp(i,njm1,k)
...
!$omp do schedule(runtime) private(i,k)
            ...
            do k=2,nk-2
            do i=2,ni-2
              sf(i,njm1,k)=sp(i,njm1,k)+scpy(i,k,2)                     &
     &          *(sp(i,njm2,k)-sp(i,njm1,k))-dmpdt*sp(i,njm1,k)
            end do
            end do
