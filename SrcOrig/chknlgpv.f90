...
!-- Modifying by satoki
!ORIG      if(nggopt.ne.0.and.nggopt.ne.1) then
      if(nggopt.ne.0.and.nggopt.ne.1.and.nggopt.ne.2) then
...
!-- Modifying by satoki
!ORIG      if(nggopt.eq.1.or.exbopt.ge.1
      if(nggopt.eq.1.or.nggopt.eq.2.or.exbopt.ge.1    &
