...
!***********************************************************************
      subroutine s_unidmprd(fpexprim,fpcrsdir,fpncexp,fpnccrs,fpwlngth, &
...
! Open the united file.
  ...
  100 if(stat.ne.0) then
        ...
        call destroy('unidmprd',8,'stop',1,'              ',14,iouni,   &
     &               stat)

      end if

      call outstd03('unidmprd',8,unifl,ncexp+22,iouni,1,1,ctime)
...
! Open the dumped file.
  ...
  110       if(stat.ne.0) then
              ...
              call destroy('unidmprd',8,'cont',1,'              ',14,   &
     &                     iodmp(0),stat)
            ...
            call outstd03('unidmprd',8,dmpfl,ncexp+31,iodmp(0),1,1,     &
     &                    ctime)
  ...
  120       if(stat.ne.0) then
     ...
     &                     iodmp(0),stat)
            ...
            call outstd03('unidmprd',8,dmpfl,ncexp+30,iodmp(0),1,1,     &
     &                    ctime)
...
! united file.
  ...
  130     if(recdmp.eq.1) then
            ...
            call destroy('unidmprd',8,'cont',3,'              ',14,     &
     &                   iodmp(0),stat)
            ...
            call outstd03('unidmprd',8,dmpfl,108,iodmp(0),3,1,ctime)

          end if

          call outstd03('unidmprd',8,unifl,108,iouni,4,1,ctime)
...
! Close the dumped file.
  ...
  140     if(stat.ne.0) then
            ...
            call destroy('unidmprd',8,'cont',2,'              ',14,     &
     &                   iodmp(0),stat)
          ...
          call outstd03('unidmprd',8,unifl,108,iodmp(0),2,1,ctime)
...
! Close the united file.
  ...
  150 if(stat.ne.0) then
        ...
        call destroy('unidmprd',8,'stop',2,'              ',14,iouni,   &
     &               stat)

      end if

      call outstd03('unidmprd',8,unifl,108,iouni,2,1,ctime)
...
! If error occured, call the procedure destroy.
  ...
  160 call destroy('unidmprd',8,'cont',4,'              ',14,iouni,     &
     &             stat)
  ...
  180 if(stat.ne.0) then
     ...
     &               stat)
      ...
      call destroy('unidmprd',8,'stop',1001,'              ',14,101,    &
     &             stat)

! -----

      end subroutine s_unidmprd

!-----7--------------------------------------------------------------7--

      end module m_unidmprd
