...
!***********************************************************************
      subroutine s_timefld(fpsfcopt,fpcphopt,fphaiopt,fpqcgopt,         &
     &                  fpaslopt,fptrkopt,fptubopt,fpfilcoe,fpdmpvar,   &
     &                  fmois,dtsoil,ni,nj,nk,nqw,nnw,nqi,nni,nqa,nund, &
     &                  land,up,uf,vp,vf,wp,wf,ppp,ppf,ptpp,ptpf,qvp,   &
     &                  qvf,qwtrp,qwtrf,nwtrp,nwtrf,qicep,qicef,nicep,  &
     &                  nicef,qcwtrp,qcwtrf,qcicep,qcicef,qaslp,qaslf,  &
...
! Internal shared variables
      ...
      character(len=108) dmpvar   ! Option for dump variables
...
!$omp do schedule(runtime) private(i,j)
        ...
        do i=1,ni-1
          ...
          dmpfltpt(i,j,k)=filcoe*(ptpf(i,j,k)-2.0e0*ptp(i,j,k)+ptpp(i,j,k))
...
!!!! -----
      ...
      end subroutine s_timefld

!-----7--------------------------------------------------------------7--

      end module m_timefld
