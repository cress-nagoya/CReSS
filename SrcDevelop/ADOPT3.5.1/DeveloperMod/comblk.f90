...
! Module variables
      ...
      real, allocatable, save :: dqdt(:,:,:)
                       ! Total heating rate of cloud physics processes

      real, allocatable, save :: dqadt(:,:,:)
                       ! Accumulated heating rate of cloud physics processes

      real, allocatable, save :: vdvc(:,:,:)
                       ! Temporary variable related to dqdt

      real, allocatable, save :: vdvc2(:,:,:)
                       ! Temporary variable related to dqdt
