...
! For the section, outfomat.
     ...
     &  .and.dmpvar(4:4).ne.'-'.and.dmpvar(4:4).ne.'x') then
      ...
      if(dmpvar(5:5).ne.'o'.and.dmpvar(5:5).ne.'+'                      &
     ...
     &  .and.dmpvar(12:12).ne.'-'.and.dmpvar(12:12).ne.'x') then
      ...
      if(dmpvar(15:15).ne.'o'.and.dmpvar(15:15).ne.'x'.and.             &
     &   dmpvar(15:15).ne.'+'.and.dmpvar(15:15).ne.'-') then
        ierr=ierr+1
      end if

      if(dmpvar(16:16).ne.'o'.and.dmpvar(16:16).ne.'x'.and.             &
     &   dmpvar(16:16).ne.'+'.and.dmpvar(16:16).ne.'-') then
        ierr=ierr+1
      end if

!      if(dmpvar(17:17).ne.'o'.and.dmpvar(17:17).ne.'x'.and.             &
!     &   dmpvar(17:17).ne.'+'.and.dmpvar(17:17).ne.'v') then
!        ierr=ierr+1
!      end if

      if(dmpvar(17:17).ne.'o'.and.dmpvar(17:17).ne.'x') then
        ierr=ierr+1
      end if
