...
!                   2011/01/19, 2011/05/16, 2011/07/15, 2011/08/09,
...
!-----7-------------------------------------------------------------------------
 ...
 &sysdep
  savmem = 1           ! integer(kind=[4bytes])
                       ! Option for memory saving
 /

 &runame
  exprim = 'test'      ! character(len=108,kind=[1byte])
                       ! Optional run name. We can set 64 characters.
 /

 &drname
  crsdir = './'        ! character(len=108,kind=[1byte])
                       ! User specified directory for CReSS processing files

  datdir = './'        ! character(len=108,kind=[1byte])
                       ! User specified directory for external data files
 /

 &dimset
  numpe  =   4         ! integer(kind=[4bytes])
 ...
 &flength
  ...
  etime  = 86400.e0    ! real(kind=[4bytes])
 ...
 &gpvpram
  ...
  gpvitv = 10800.e0    ! real(kind=[4bytes])
                       ! Time interval of external GPV file [s]
  aslitv = 10800.e0    ! real(kind=[4bytes])
  ...
  nggvar = 'xxxxxxxx'  ! character(len=108,kind=[1byte])
  ...
  exbvar = '--x---xx'  ! character(len=108,kind=[1byte])
  ...
  wdnews =    40       ! integer(kind=[4bytes])
                       ! Lateral sponge damping thickness

  wdnorm =     2       ! integer(kind=[4bytes])
  ...
  botgpv =  4800.e0    ! real(kind=[4bytes])
                       ! Lowest height of vertical sponge damping
                       ! for external data [m]
  botbar =  9600.e0    ! real(kind=[4bytes])
                       ! Lowest height of vertical sponge damping
                       ! for base state or 0 [m]
 /

 &rdrpram
  rdrvar = 'xxxx'      ! character(len=108,kind=[1byte])
  ...
  ngrvar = 'xxxxx'     ! character(len=108,kind=[1byte])
 ...
 &sfcphys
  sfcdat = 'xox'       ! character(len=108,kind=[1byte])
  ...
  sstcst = 301.16e0    ! real(kind=[4bytes])
 ...
 &initype
  ...
  sndtyp = 'ppm'       ! character(len=108,kind=[1byte])
 ...
 &integrat
  dtbig  = 10.e0       ! real(kind=[4bytes])
                       ! Large time steps interval [s]
  dtsml  =  5.e0       ! real(kind=[4bytes])
 ...
 &outfomat
  ...
  dmpvar = '--ooo-oxoooooox'
                       ...
                       ! variables, surface precipitation and z physical
                       ! coordinates in order. We can set only 15 characters.
  ...
  dmpitv =  1200.e0    ! real(kind=[4bytes])
                       ! Time interval of dumped files [s]

  monitv =  1200.e0    ! real(kind=[4bytes])
  ...
  mxnitv =   120.e0    ! real(kind=[4bytes])
...
!-----7-------------------------------------------------------------------------
 ...
 &datconf_gpv
  ...
  rotopt_gpv = 1       ! integer(kind=[4bytes])
  ...
  datype_gpv = 'tr'    ! character(len=108,kind=[1byte])
  ...
  refsfc_gpv = 1       ! integer(kind=[4bytes])
...
!-----7-------------------------------------------------------------------------
 ...
 &datconf_rdr
  ...
  datype_rdr = 'r'     ! character(len=108,kind=[1byte])
...
!-----7-------------------------------------------------------------------------
 ...
 &gridset_trn
  xdim_trn = 3600      ! integer(kind=[4bytes])
                       ! Terrain data dimension in x direction
  ydim_trn = 3600      ! integer(kind=[4bytes])
...
!-----7-------------------------------------------------------------------------
 ...
 &uniconf_uni
  fltyp_uni  = 'dmp'   ! character(len=108,kind=[1byte])
  ...
  flitv_uni  = 1200.e0 ! real(kind=[4bytes])
